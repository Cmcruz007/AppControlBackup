          ...
          <div className="settings-wrapper">
            {config?.pin && !pinUnlocked ? (
              <div className="pin-section">
                ...
                <input type="password" value={pinInput} onChange={(e) => setPinInput(e.target.value)} placeholder="Introduce PIN..." />
            ...
            <div className="modal-body">
              ...
              {detail.allEmails && detail.allEmails.length > 0 && (
                <div className="email-log" style={{ marginTop: '20px' }}>
                  <h3>Log de correos detectados:</h3>
